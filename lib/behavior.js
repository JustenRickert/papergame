define(["require", "exports", "./globaldeclarations", "./circle", "./vector", "./life", "./bullet", "./graph", "./life"], function (require, exports, globaldeclarations_1, circle_1, vector_1, life_1, bullet_1, graph_1, life_2) {
    "use strict";
    ...
    var WanderCloselyBehavior = (function () {
        function WanderCloselyBehavior() {
            ...
            this.wanderRadius = 7;
            this.reinitialize = function () {
                _this.positionToMove = vector_1.Vector.times(globaldeclarations_1.canvas.height, vector_1.Vector.random());
                _this.wanderPosition = vector_1.Vector.times(globaldeclarations_1.canvas.height, vector_1.Vector.random());
            };
            ...
            this.positionToMove = vector_1.Vector.times(globaldeclarations_1.canvas.height, vector_1.Vector.random());
            this.wanderPosition = vector_1.Vector.times(globaldeclarations_1.canvas.height, vector_1.Vector.random());
        }
