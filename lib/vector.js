define(["require", "exports", "./globaldeclarations"], function (require, exports, globaldeclarations_1) {
    "use strict";
    var Vector = (function () {
        function Vector(x, y) {
            this.x = x;
    ...
    Shape.drawRect = function (position, direction) {
        ...
        globaldeclarations_1.GAME_CTX.moveTo(frontLeft.x, frontLeft.y);
        globaldeclarations_1.GAME_CTX.lineTo(frontRight.x, frontRight.y);
        globaldeclarations_1.GAME_CTX.lineTo(backLeft.x, backLeft.y);
        globaldeclarations_1.GAME_CTX.lineTo(backRight.x, backRight.y);
    ...
    Shape.drawThinTriangle = function (position, direction) {
        ...
        globaldeclarations_1.GAME_CTX.beginPath();
        globaldeclarations_1.GAME_CTX.moveTo(forwardPoint.x, forwardPoint.y);
        globaldeclarations_1.GAME_CTX.lineTo(backLeft.x, backLeft.y);
        globaldeclarations_1.GAME_CTX.lineTo(backRight.x, backRight.y);
        globaldeclarations_1.GAME_CTX.fill();
        globaldeclarations_1.GAME_CTX.closePath();
