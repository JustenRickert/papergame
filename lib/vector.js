define(["require", "exports", "./globaldeclarations"], function (require, exports, globaldeclarations_1) {
    ...
    Shape.drawRect = function (position, direction) {
        ...
        globaldeclarations_1.ctx.moveTo(frontLeft.x, frontLeft.y);
        globaldeclarations_1.ctx.lineTo(frontRight.x, frontRight.y);
        globaldeclarations_1.ctx.lineTo(backLeft.x, backLeft.y);
        globaldeclarations_1.ctx.lineTo(backRight.x, backRight.y);
    ...
    Shape.drawThinTriangle = function (position, direction) {
        ...
        globaldeclarations_1.ctx.beginPath();
        globaldeclarations_1.ctx.moveTo(forwardPoint.x, forwardPoint.y);
        globaldeclarations_1.ctx.lineTo(backLeft.x, backLeft.y);
        globaldeclarations_1.ctx.lineTo(backRight.x, backRight.y);
        globaldeclarations_1.ctx.fill();
        globaldeclarations_1.ctx.closePath();
