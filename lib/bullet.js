define(["require", "exports", "./vector", "./sound"], function (require, exports, vector_1, sound_1) {
    "use strict";
    var shortHighBeep = sound_1.Sound.playShortHighBeep;
    var hitBulletSound = sound_1.Sound.playHitBulletSound;
    var Bullet = (function () {
        function Bullet(position, direction, color, damage) {
            ...
            this.draw = function (ctx) {
                return vector_1.Shape.drawThinTriangle(_this.pos, _this.vel, ctx);
            };
            this.pos = position;
            this.vel = direction;
            this.color = color;
    ...
    Bullet.shoot = function (position, direction, color, damage, graph) {
        graph.bullets.push(new Bullet(position, vector_1.Vector.times(Bullet.speed, direction), color, damage));
        shortHighBeep();
    };
