define(["require", "exports", "./globaldeclarations", "./collisionbucket", "./vector"], function (require, exports, globaldeclarations_1, collisionbucket_1, vector_1) {
    "use strict";
    var Graph = (function () {
        function Graph(player, enemy) {
            ...
            this.drawCircle = function (circle) {
                globaldeclarations_1.GAME_CTX.beginPath();
                globaldeclarations_1.GAME_CTX.arc(circle.pos.x, circle.pos.y, circle.radius, 0, 2 * Math.PI);
                globaldeclarations_1.GAME_CTX.closePath();
                globaldeclarations_1.GAME_CTX.fillStyle = circle.color;
                globaldeclarations_1.GAME_CTX.fill();
                globaldeclarations_1.GAME_CTX.beginPath();
                globaldeclarations_1.GAME_CTX.moveTo(circle.pos.x + (3 * circle.radius / 4) * Math.sin(circle.direction), circle.pos.y + (3 * circle.radius / 4) * Math.cos(circle.direction));
                globaldeclarations_1.GAME_CTX.lineTo(circle.pos.x + (2 * circle.radius / 4) * Math.sin(circle.direction + Math.PI / 3), circle.pos.y + (2 * circle.radius / 4) * Math.cos(circle.direction + Math.PI / 3));
                globaldeclarations_1.GAME_CTX.lineTo(circle.pos.x + (2 * circle.radius / 4) * Math.sin(circle.direction - Math.PI / 3), circle.pos.y + (2 * circle.radius / 4) * Math.cos(circle.direction - Math.PI / 3));
                globaldeclarations_1.GAME_CTX.fillStyle = circle.bandColor;
                globaldeclarations_1.GAME_CTX.fill();
                globaldeclarations_1.GAME_CTX.closePath();
            };
            ...
            this.size = { height: globaldeclarations_1.GAME_CANVAS.height, width: globaldeclarations_1.GAME_CANVAS.width };
