define(["require", "exports", "./vector", "./life", "./behavior"], function (require, exports, vector_1, life_1, behavior_1) {
    "use strict";
    var Circle = (function () {
        function Circle(id, radius, pos, dPos, vel, teamColor, dColor, color, bandColor, direction, speed, turnRate) {
            ...
            this.wander = new behavior_1.WanderCloselyBehavior(this.pos);
            this.alive = true;
        }
        return Circle;
    }());
