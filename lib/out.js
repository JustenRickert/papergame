...
var Graph = (function () {
    function Graph(player) {
        ...
        this.closestDirtyVertex = function (v) {
...
var Circle = (function () {
    ...
    Circle.prototype.behave = function (v, game) {
...
var simpleAimShootBehavior = (function () {
    ...
    simpleAimShootBehavior.prototype.condition = function (v, game) {
        return true;
    };
    simpleAimShootBehavior.prototype.consequence = function (v, game) {
        return;
    };
...
var CollisionBucket = (function () {
    function CollisionBucket(graph) {
        ...
        this.gridIndexToCollisionBucket = function (bucketIndex) {
        ...
        for (var _i = 0, _a = graph.vertexes; _i < _a.length; _i++) {
            var v = _a[_i];
            var index = this.gridIndexToCollisionBucket(graph.gridIndexOf(v, this.lines));
