...
var Game = (function () {
    function Game(player, enemy) {
        ...
        this.reinitialize = function (winOrLoss) {
            ...
            _this.graph.player.circle.forEach(function (c) { return c.teamColor = "red"; });
            _this.graph.enemy.circle.forEach(function (c) { return c.teamColor = "blue"; });
...
var AttackBehavior = (function () {
    function AttackBehavior() {
        ...
        this.consequence = function (attackV, game) {
            _this.targetEdge = attackV.edges.filter(Graph.isDirty).filter(function (edge) {
                return edge.child.circle.life.health !== 0
                    || edge.child.circle.life.health !== NaN;
            })[0];
