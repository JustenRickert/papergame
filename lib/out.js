...
var CollisionBucket = (function () {
    function CollisionBucket(graph) {
        ...
        for (var _i = 0, _a = graph.vertexes; _i < _a.length; _i++) {
            var v = _a[_i];
            var index = CollisionBucket.gridIndexToCollisionBucketIndex(this.gridIndexOf(v.circle.pos));
            !this.bucket[index]
                ? this.bucket[index] = [v]
...
var Bullet = (function () {
    function Bullet(position, direction, color, damage) {
        var _this = this;
        this.size = 2;
        this.isDirty = function (v) { return _this.color !== v.circle.color; };
...
var Graph = (function () {
    function Graph(player) {
        ...
        this.outOfBoundsBulletsRun = function () { return _this.bullets.forEach(function (b) { return b.isThenOutOfBounds(_this); }); };
...
var AttackBehavior = (function () {
    function AttackBehavior() {
        ...
        this.consequence = function (attackV, game) {
            ...
            if (Math.abs(attackV.circle.angleToCircle(_this.targetV.circle)) < .1 &&
                Vector.distance(attackV.circle.pos, _this.targetV.circle.pos) < _this.attackRange) {
...
var SimpleAimShootBehavior = (function () {
    function SimpleAimShootBehavior() {
        ...
        this.shootBullet = function (v, game) {
            ...
            Bullet.shoot(v.circle.pos, Vector.times(1 / Vector.mag(dirTo), dirTo), v.circle.color, _this.bShoot.damage, game.graph);
